...
nStrongCornersList=[500,1000,2000,3000,4000]; %shoter trail list can be applicable: [500,1000,2000,4000];
...
%Left fore wing
nStrongCornersList=[1000,1500,2000,3000,4000]; %shoter trail list can be applicable: [1000,1500,2000,4000];
